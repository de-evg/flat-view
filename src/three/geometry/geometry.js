...
const generateFlat = (extWidth = DEFAULT_EXT_WIDTH, innerWidth = DEFAULT_INNER_WIDTH, extDepth = DEFAULT_EXT_DEPTH, innerDepth = DEFAULT_INNER_DEPTH, height = DEFAULT_HEIGHT) => {
  const WallPoint = {
    ext: {
      x: extWidth,
      y: height,
...
const generateInnerWall = (width, height, depth) => {
...
export { generateFlat, generateInnerWall };
